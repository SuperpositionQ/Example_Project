                ...
                <div class="row">
                    ...
                    <div class="mainsection">
                        <form method="post">
                            ...
                            <input type="text" name="catname" placeholder="Enter Category" value="<?php echo $name ?>"><br><br>
                            <input type="date" name="catyear" placeholder="Enter Year" value="<?php echo $year ?>"><br><br>
                            <input type="text" name="catartist" placeholder="Enter Artist Name" value="<?php echo $artist ?>"><br><br>
                            <input type="text" name="catsong" placeholder="Enter Song" value="<?php echo $song ?>"><br><br>
                            <input type="text" name="catalbum" placeholder="Enter Album" value="<?php echo $album ?>"><br><br>
                            <input type="file" name="catfile" placeholder="Insert File" value="<?php echo $file ?>"><br><br>
                    ...
                    if (isset($_POST['submitupdate'])) {
                        ...
                        $query = "UPDATE tbl_category SET category_select = '$name' , category_year = '$year', category_artist = '$artist', song_name = '$song', category_album = '$album', add_file = '$file' WHERE category_id = $id ";
