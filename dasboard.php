    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="navi">
                    <ul>
                        <li class="active"><a href="dasboard.php"><i class="fa fa-lock" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Admin Table</span></a></li>
                    ...
                    <div class="mainsec">
                        <table border="1">
                            ...
                            <a href ='AdminDelete.php?id=$row[id]'>Delete</a>
                              <a href = 'AdminUpdate.php?id=$row[id]&name=$row[name]&email=$row[email]&phone=$row[phone]&pass=$row[pass]'>Update</a>
                            </td>  ";
                                echo "</tr>";
                            }
                        ...
                        <a href="Addadmin.php"><button style="width: 100%; color:white; background-color:#fc0254; padding:8px;">Add User</button></a>
