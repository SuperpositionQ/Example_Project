...
<body>
    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            ...
            <h2 style="text-align:Center; font-size: 30px; margin-top:20px;">Edit Employee</h2>
                ...
                <div class="row">
                    ...
                    <div class="mainsection">
                        <form method="post">
                            ...
                            <input type="text" name="txtadr" value="<?php echo $address ?>"><br><br>
                            <input type="text" name="txteml" value="<?php echo $email ?>"><br><br>
                            <input type="number" name="txtphone" value="<?php echo   $phone ?>"><br><br>
                            <input type="text" name="txtpass" value="<?php echo   $password ?>"><br><br>
                    ...
                    if (isset($_POST['submitupdate'])) {
                        ...
                        $query = "UPDATE tbl_user SET user_name = '$name' , user_address = '$address' ,user_email = '$email', user_phone = '$phone', user_pass = '$password' WHERE user_id = $id ";
