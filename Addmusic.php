                ...
                <div class="row">
                    <div class="mainsec">
                        ...
                        <div class="mainsection" >
                            <h2 style="text-align:Center; font-size: 30px;">Add Music</h2> <br><br>
                            <form method="post">
                                <!-- <input type="number" name="textid" placeholder="Enter Your Id"><br><br> -->
                                <input type="text" name="textname" placeholder="Enter Music Name"><br><br>
                                <input type="text" name="txteml" placeholder="Enter Artist Name"><br><br>
                                <input type="text" name="txtcat" placeholder="Enter Music Category"><br><br>
                                <input type="file" name="txtphone" placeholder="Enter Audio"><br><br>
                                <input type="date" name="txtpass" placeholder="Enter Music Year"><br><br>
                                <input type="file" name="txtimg" placeholder="Enter Music Image"><br><br>
                        ...
                        if (isset($_POST['btninsert'])) {
                            ...
                            $query = "INSERT INTO tbl_music (music_name,music_artist,music_category,music_audio,music_year,music_img) VALUES ('$name','$email','$category','$phone','$pass','$img')";
