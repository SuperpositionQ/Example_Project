            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="category.php"><i class="fa fa-bars" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Category Table</span></a></li>
                    ...
                    <div class="mainsec">
                        <table border="1">
                            ...
                            foreach ($result as $row) {
                                ...
                                echo "<td>$row[category_select]</td>";
                                echo "<td>$row[category_year]</td>";
                                echo "<td>$row[category_artist]</td>";
                                echo "<td>$row[song_name]</td>";
                                echo "<td>$row[category_album]</td>";
                                echo "<td>$row[add_file]</td>";
                                echo "<td>
                            <a href ='CatDelete.php?id=$row[category_id]'>Delete</a>
                              <a href = 'CatUpdate.php?id=$row[category_id]&name=$row[category_select]&year=$row[category_year]&artist=$row[category_artist]&song=$row[song_name]&album=$row[category_album]&file=$row[add_file]'>Update</a>
                            </td>  ";
                                echo "</tr>";
                            }
                        ...
                        <a href="Addcategory.php"><button style="width: 100%; color:white; background-color:#fc0254; padding:8px;">Add Music</button></a>
