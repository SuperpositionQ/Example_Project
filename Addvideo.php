                ...
                <div class="row">
                    <div class="mainsec">
                        ...
                        <div class="mainsection" >
                            <h2 style="text-align:Center; font-size: 30px;">Add video</h2> <br><br>
                            <form method="post">
                                <!-- <input type="number" name="textid" placeholder="Enter Your Id"><br><br> -->
                                <input type="text" name="textname" placeholder="Enter Video Name"><br><br>
                                <input type="text" name="txteml" placeholder="Enter Artist Name"><br><br>
                                <input type="file" name="txtcat" placeholder="Enter File"><br><br>
                        ...
                        if (isset($_POST['btninsert'])) {
                            ...
                            $query = "INSERT INTO tbl_video (video_name,video_artist,video_file) VALUES ('$name','$email','$category')";
