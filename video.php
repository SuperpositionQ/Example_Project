...
<head>
    ...
    <meta name="keywords" content="video, html">
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="video.php"><i class="fa fa-camera" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Video Table</span></a></li>
                    ...
                    <div class="mainsec">
                        <table border="1">
                            ...
                            foreach ($result as $row) {
                                ...
                                echo "<td>$row[video_artist]</td>";
                                echo "<td>$row[video_file]</td>";
                                echo "<td>
                            <a href ='videoDelete.php?id=$row[video_id]'>Delete</a>
                              <a href = 'videoUpdate.php?id=$row[video_id]&name=$row[video_name]&artist=$row[video_artist]&file=$row[video_file]'>Update</a>
                            </td>  ";
                                echo "</tr>";
                            }
                        ...
                        <a href="Addvideo.php"><button style="width: 100%; color:white; background-color:#fc0254; padding:8px;">Add video</button></a>
