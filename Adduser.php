                ...
                <div class="row">
                    <div class="mainsec">
                        <div class="mainsection">
                            <h2 style="text-align:Center; font-size: 30px;">Add User</h2> <br><br>
                            <form method="post">
                                <!-- <input type="number" name="textid" placeholder="Enter Your Id"><br><br> -->
                                <input type="text" name="textname" placeholder="Enter Your name"><br><br>
                                <input type="text" name="txteml" placeholder="Enter Your Email"><br><br>
                                <input type="number" name="txtphone" placeholder="Enter Your Phone"><br><br>
                                <input type="text" name="txtadr" placeholder="Enter Your Address"><br><br>
                        ...
                        if (isset($_POST['btninsert'])) {
                            // $id = $_POST['textid'];
                            $name = $_POST['textname'];
                            $address = $_POST['txtadr'];
                            $phone = $_POST['txtphone'];
                            $email = $_POST['txteml'];
                            $pass = $_POST['txtpass'];

                            include("connectivity.php");
                            $query = "INSERT INTO tbl_user (user_name,user_address,user_phone,user_email,user_pass) VALUES ('$name','$address',$phone,'$email','$pass')";
