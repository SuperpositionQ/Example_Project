    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                <h2 style="text-align:Center; font-size: 30px; margin-top:20px;">Update video</h2>
                ...
                <div class="row">
                    ...
                    <div class="mainsection">
                        <form method="post">
                            ...
                            <input type="file" name="txtcat" value="<?php echo $category ?>"><br><br>
                    ...
                    if (isset($_POST['submitupdate'])) {
                        ...
                        $query = "UPDATE tbl_video SET video_name = '$name' ,video_artist = '$email', video_file = '$category' WHERE video_id = $id ";
