            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="music.php"><i class="fa fa-music" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Music Table</span></a></li>
                    ...
                    <div class="mainsec">
                        <table border="1">
                            ...
                            foreach ($result as $row) {
                                ...
                                echo "<td>$row[music_artist]</td>";
                                echo "<td>$row[music_category]</td>";
                                echo "<td>$row[music_audio]</td>";
                                echo "<td>$row[music_year]</td>";
                                echo "<td>$row[music_img]</td>";
                                echo "<td>
                            <a href ='MusicDelete.php?id=$row[music_id]'>Delete</a>
                              <a href = 'MusicUpdate.php?id=$row[music_id]&name=$row[music_name]&artist=$row[music_artist]&category=$row[music_category]&audio=$row[music_audio]&year=$row[music_year]&img=$row[music_img]'>Update</a>
                            </td>  ";
                                echo "</tr>";
                            }
                        ...
                        <a href="Addmusic.php"><button style="width: 100%; color:white; background-color:#fc0254; padding:8px;">Add Music</button></a>
